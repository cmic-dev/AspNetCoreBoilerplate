    ...
    public partial class AddAuthModule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "auth",
                table: "Users",
                columns: new[] { "Id", "DeletedAt", "DeletedById", "Email", "FailedLoginAttempts", "IsSystem", "LastFailedLoginAt", "LastSuccessfulLoginAt", "Password", "PasswordChangedAt", "RequiresPasswordChange", "RoleId", "UserName" },
                values: new object[,]
                {
                    { new Guid("0a622c44-e9a4-414e-b8af-44d70c90f0b3"), null, null, "", 0, true, null, null, "sD3fPKLnFKZUjnSV4qA/XoJOqsmDfNfxWcZ7kPtLc0I=", null, false, new Guid("a1a2e5e2-95d3-4cb6-a56d-4f7e01c8921c"), "system" },
                    { new Guid("b348eeb7-f5b7-4076-9a57-168f9052c342"), null, null, "", 0, true, null, null, "sD3fPKLnFKZUjnSV4qA/XoJOqsmDfNfxWcZ7kPtLc0I=", null, false, new Guid("a1a2e5e2-95d3-4cb6-a56d-4f7e01c8921c"), "admin" }
                });
